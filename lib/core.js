...
module.exports = {
  createClass: function(chartType, methodNames, dataKey) {
    ...
    classData.componentWillUpdate = function(nextProps) {
      var chart = this.state.chart;
    ...
    classData.shouldComponentUpdate = function(nextProps, nextState) {
      return nextProps.redraw || (this.props.data !== nextProps.data);
    };
